...
@Component({
  selector: 'app-consultar-eventos-jbst',
  templateUrl: './consultar-eventos-jbst.component.html',
  styleUrls: ['./consultar-eventos-jbst.component.css']
})
export class ConsultarEventosJbstComponent {
  ...
  consultarEventos() {
    this.EventosService.consultarEventosMesAtual().subscribe(
