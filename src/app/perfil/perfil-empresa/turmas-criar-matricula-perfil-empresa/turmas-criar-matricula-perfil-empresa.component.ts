  ...
  obterEmpresas(userId: string): void {
    ...
    this.httpClient.get<any[]>(endpoint)
      ...
      obterFaturamentosEmAberto(userId: string): void {
        const endpoint = `https://seguranca-do-trabalho-jb-env.eba-izb9phrg.us-east-1.elasticbeanstalk.com/api/faturamento/api/faturamentos-em-aberto/usuario/${userId}`;
