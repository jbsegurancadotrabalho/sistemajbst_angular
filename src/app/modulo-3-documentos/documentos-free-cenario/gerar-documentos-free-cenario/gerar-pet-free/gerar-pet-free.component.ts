...
@Component({
  selector: 'app-gerar-pet-free',
  templateUrl: './gerar-pet-free.component.html',
  styleUrls: ['./gerar-pet-free.component.css']
})
export class GerarPetFreeComponent implements OnInit {
