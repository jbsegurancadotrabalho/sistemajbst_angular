...
@Component({
  selector: 'app-gerar-pt-free',
  templateUrl: './gerar-pt-free.component.html',
  styleUrls: ['./gerar-pt-free.component.css']
})
export class GerarPtFreeComponent implements OnInit {
