...
@Component({
  selector: 'app-gerar-apr-free',
  templateUrl: './gerar-apr-free.component.html',
  styleUrls: ['./gerar-apr-free.component.css']
})
export class GerarAprFreeComponent implements OnInit {
