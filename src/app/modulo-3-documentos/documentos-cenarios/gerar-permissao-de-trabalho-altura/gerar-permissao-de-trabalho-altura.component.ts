...
@Component({
  selector: 'app-gerar-permissao-de-trabalho-altura',
  templateUrl: './gerar-permissao-de-trabalho-altura.component.html',
  styleUrls: ['./gerar-permissao-de-trabalho-altura.component.css']
})
export class GerarPermissaoDeTrabalhoAlturaComponent implements OnInit {
  ...
  consultarDocumentosUnidades(): void {
    ...
    if (id) {
      this.documentosService.consultarDocumentosCenariosPorId(id).subscribe(
        (data: any) => {
