...
@Component({
  selector: 'app-gerar-laudo-ergonomico',
  templateUrl: './gerar-laudo-ergonomico.component.html',
  styleUrls: ['./gerar-laudo-ergonomico.component.css']
})
export class GerarLaudoErgonomicoComponent implements OnInit {
