...
@Component({
  selector: 'app-consultar-cursos-credenciados',
  templateUrl: './consultar-cursos-credenciados.component.html',
  styleUrls: ['./consultar-cursos-credenciados.component.css']
})
export class ConsultarCursosCredenciadosComponent implements OnInit {
