...
@Component({
  selector: 'app-consultar-agendamentos-funcionario',
  templateUrl: './consultar-agendamentos-funcionario.component.html',
  styleUrls: ['./consultar-agendamentos-funcionario.component.css']
})
export class ConsultarAgendamentosFuncionarioComponent implements OnInit {
  ...
  consultarAgendamentosPorFuncionario(mes: number, ano: number): void {
    this.agendamentoService.consultarAgendamentoPorMesFuncionario(mes, ano).subscribe(
      (data: any[]) => {
