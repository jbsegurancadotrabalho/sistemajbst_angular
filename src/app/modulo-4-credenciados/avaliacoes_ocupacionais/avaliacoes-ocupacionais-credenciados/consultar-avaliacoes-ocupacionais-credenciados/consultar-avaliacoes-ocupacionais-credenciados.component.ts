...
@Component({
  selector: 'app-consultar-avaliacoes-ocupacionais-credenciados',
  templateUrl: './consultar-avaliacoes-ocupacionais-credenciados.component.html',
  styleUrls: ['./consultar-avaliacoes-ocupacionais-credenciados.component.css']
})
export class ConsultarAvaliacoesOcupacionaisCredenciadosComponent implements OnInit {
    ...
    if (this.id) {
      this.CredenciadoService.consultarCredenciadoPorId(this.id).subscribe(
        (data: GetCredenciadosModel) => {
          ...
          this.credenciados = data.cursoscredenciados
          this.credenciados = data.avaliacoescredenciados
