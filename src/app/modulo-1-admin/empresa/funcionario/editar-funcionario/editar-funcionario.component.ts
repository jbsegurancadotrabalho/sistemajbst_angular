...
export class EditarFuncionarioComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit(): void {
    ...
    this.httpClient.get('http://empresa-jb-env.eba-vj7gm5ar.us-east-2.elasticbeanstalk.com/api/funcao').subscribe({
