...
@Component({
  selector: 'app-consultar-suporte-ao-cliente',
  templateUrl: './consultar-suporte-ao-cliente.component.html',
  styleUrls: ['./consultar-suporte-ao-cliente.component.css']
})
export class ConsultarSuporteAoClienteComponent {
